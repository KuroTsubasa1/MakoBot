  ...
  slotsLogic: function(slotRows, coins, content) {
    ...
    if (content === 'multislots') {
      ...
      if (slotRows[0] == 1 && slotRows[1] == 1 && slotRows[2] == 1 || slotRows[3] == 1 && slotRows[4] == 1 && slotRows[5] == 1 || slotRows[6] == 1 && slotRows[7] == 1 && slotRows[8] == 1) {
        ...
        mltipler = mltipler + 64;
      }

      if (slotRows[0] == 1 && slotRows[3] == 1 && slotRows[6] == 1 || slotRows[1] == 1 && slotRows[4] == 1 && slotRows[7] == 1 || slotRows[2] == 1 && slotRows[5] == 1 && slotRows[8] == 1 ) {
          mltipler = mltipler + 2;
      } else if (slotRows[0] == 2 && slotRows[3] == 2 && slotRows[6] == 2 || slotRows[1] == 2 && slotRows[4] == 2 && slotRows[7] == 2 || slotRows[2] == 2 && slotRows[5] == 2 && slotRows[8] == 2 ) {
          mltipler = mltipler + 4;
      } else if (slotRows[0] == 3 && slotRows[3] == 3 && slotRows[6] == 3 || slotRows[1] == 3 && slotRows[4] == 3 && slotRows[7] == 3 || slotRows[2] == 3 && slotRows[5] == 3 && slotRows[8] == 3 ) {
          mltipler = mltipler + 8;
      } else if (slotRows[0] == 4 && slotRows[3] == 4 && slotRows[6] == 4 || slotRows[1] == 4 && slotRows[4] == 4 && slotRows[7] == 4 || slotRows[2] == 4 && slotRows[5] == 4 && slotRows[8] == 4 ) {
          mltipler = mltipler + 16;
      } else if (slotRows[0] == 5 && slotRows[3] == 5 && slotRows[6] == 5 || slotRows[1] == 5 && slotRows[4] == 5 && slotRows[7] == 5 || slotRows[2] == 5 && slotRows[5] == 5 && slotRows[8] == 5 ) {
          mltipler = mltipler + 32;
      } else if (slotRows[0] == 6 && slotRows[3] == 6 && slotRows[6] == 6 || slotRows[1] == 6 && slotRows[4] == 6 && slotRows[7] == 6 || slotRows[2] == 6 && slotRows[5] == 6 && slotRows[8] == 6 ) {
          mltipler = mltipler + 64;
      }
    }
